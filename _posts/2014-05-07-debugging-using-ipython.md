One of the fastest (and dirtiest) ways to debug a python script is to put a pdb.set_trace() in the problematic code section, and debug the code on the command line.
